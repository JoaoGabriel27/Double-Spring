...
t, D = rungekutta4col(t0, tf, y₀, m₁, m₂, F) #t is the time vector and D is a matrix with 4 lines and interation + 1 number of columns where line 1 = positions block 1
